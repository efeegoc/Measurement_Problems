...
###################################################
# Average Rating'i Güncel Yorumlara Göre Hesaplayalım ve Var Olan Average Rating ile Kıyaslayalım.
###################################################
...
###################################################
# Veri Setini Okutalım ve Ürünün Ortalama Puanını Hesaplayalım.
###################################################
...
# Demekkı Günümüze yaklaştıkça ürünümüzün kalitesinde bir artış var.

# zaman bazlı ortalama ağırlıkların belirlenmesi
def time_based_weighted_average(dataframe, w1=28, w2=26, w3=24, w4=22): # default olarak verilmiş ağırlıklar
...
###################################################
# YORUMA VE ŞANSA YER BIRAKMADAN GÜVENEBİLECEĞİMİZ İSTATİSTİKİ BİR YOL
# ARTIK YENİ GENEL KİŞİ YÜZDE 95 GÜVEN ARALIĞI İLE BURDA YER ALIR DİYEBİLİRİZ
...
##################################################
# 20 Yorumu Belirleyelim ve Sonuçları Yorumlayalım.
###################################################
